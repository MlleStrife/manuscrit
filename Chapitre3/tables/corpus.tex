...
\end{tabular}
\caption{Principaux corpus utilisés dans la reconnaissance d'émotions dans la parole. Les trois premiers corpus correspondent à des enregistrements téléphoniques qui ne sont pas annotés en émotions. Nous les avons néanmoins considérés lors de nos travaux comme des corpus pouvant recevoir une annotation des états émotionnels. Chaque corpus est caractérisé par la langue utilisée, si les enregistrements sont issus du domaine téléphonique ou non, s'il s'agit d'un corpus acté ou spontanée et si les émotions sont annotées en continue ou non.}
\label{tab:corpus}
\end{table}
