...
Cependant nous avons voulu explorer la possibilité d'utiliser les annotations de chacun afin de construire des systèmes de reconnaissance.
...
\input{./Chapitre7/tables/phrasesPic}
